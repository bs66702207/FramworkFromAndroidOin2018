...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mHandler3.post(new Runnable() {
                    @Override
                    public void run() {//发送一个post消息，最终导致Runnable函数在looper判断callback非空然后调用run()
        ...
        myThread2 = new MyThread();//仿照HandlerThread来做的，自己实现getLooper
        myThread2.start();
        ...
        myThread3 = new HandlerThread("MessageTestThread3");//直接使用
        myThread3.start();
