...
import com.chehejia.server.se.SeManagerService;
...
public final class SystemServer {
    ...
    private static final String POWER_OFF_REBOOT = "onBoot";
...
//            SystemProperties.set("persist.sys.dalvik.vm.lib.2", VMRuntime.getRuntime().vmLibrary());
    ...
    private void startBootstrapServices() {
		...
		Slog.i(TAG, "SeManagerService Service");
		SeManagerService sms = new SeManagerService(mSystemContext);
		ServiceManager.addService(Context.SE_MANAGER_SERVICE, sms);
    ...
    private void startOtherServices() {
        ...
        mActivityManagerService.systemReady(() -> {
            ...
            traceBeginAndSlog("StartSvmUiService");
            try {
                startSvmService(context);
            } catch (Throwable e) {
                reportWtf("starting svm service", e);
            }
            traceEnd();
            ...
            Settings.System.putInt(context.getContentResolver(), POWER_OFF_REBOOT, 0);
            traceBeginAndSlog(POWER_OFF_REBOOT);
	    ...
	    traceBeginAndSlog("StartTimeService");
            try {
                startTimeService(context);
            } catch (Throwable e) {
                reportWtf("starting TimeService", e);
            }
            traceEnd();
    ...
    static final void startSvmService(Context context) {
        Intent intent = new Intent();
        intent.setComponent(new ComponentName("com.chehejia.car.svm",
                "com.chehejia.car.svm.SvmUiService"));
        context.startServiceAsUser(intent, UserHandle.SYSTEM);
    }

    static final void startTimeService(Context context) {
        Intent intent = new Intent();
        intent.setComponent(new ComponentName("com.chehejia.car.timesync",
            "com.chehejia.car.timesync.TimeService"));
        context.startServiceAsUser(intent, UserHandle.SYSTEM);
    }
